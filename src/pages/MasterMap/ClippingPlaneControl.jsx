...
const ClippingPlaneControl = ({ viewer, tileset }) => {
  const [activeAxis, setActiveAxis] = useState(null); // "Z", "X" or null
  ...
  const currentNormal = useRef(new Cesium.Cartesian3(0, 0, -1)); // Default Z
